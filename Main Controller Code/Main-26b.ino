...
#define Relay3 (12)                // Relay one connected to Pin 33
...
//    Pressure_Ref = (bmeRef.readPressure() / 100) + bmeRef_offset;
  ...
  Pressure_1 = (bme.readPressure() / 100) - Pressure_Ref;
  Humidity_1 = bme.readHumidity();
  Temperature_1 = bme.readTemperature();
}
